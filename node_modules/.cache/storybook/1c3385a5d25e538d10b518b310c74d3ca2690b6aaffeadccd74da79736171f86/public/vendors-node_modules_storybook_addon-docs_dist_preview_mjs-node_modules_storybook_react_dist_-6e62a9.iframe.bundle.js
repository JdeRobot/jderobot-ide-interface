(self["webpackChunkjderobot_ide_interface"] = self["webpackChunkjderobot_ide_interface"] || []).push([["vendors-node_modules_storybook_addon-docs_dist_preview_mjs-node_modules_storybook_react_dist_-6e62a9"],{
...
/* harmony export */ });
var excludeTags=Object.entries(globalThis.TAGS_OPTIONS??{}).reduce((acc,entry)=>{let[tag,option]=entry;return option.excludeFromDocsStories&&(acc[tag]=!0),acc},{}),parameters={docs:{renderer:async()=>{let{DocsRenderer}=await Promise.all(/*! import() */[__webpack_require__.e("vendors-node_modules_react-dom_index_js"), __webpack_require__.e("vendors-node_modules_storybook_addon-docs_dist_blocks_mjs"), __webpack_require__.e("vendors-node_modules_storybook_react-dom-shim_dist_react-18_mjs"), __webpack_require__.e("node_modules_storybook_addon-docs_dist_DocsRenderer-PQXLIZUC_mjs-node_modules_storybook_addon-5cb44f")]).then(__webpack_require__.bind(__webpack_require__, /*! ./DocsRenderer-PQXLIZUC.mjs */ "./node_modules/@storybook/addon-docs/dist/DocsRenderer-PQXLIZUC.mjs"));return new DocsRenderer},stories:{filter:story=>(story.tags||[]).filter(tag=>excludeTags[tag]).length===0&&!story.parameters.docs?.disable}}};
...
//# sourceMappingURL=vendors-node_modules_storybook_addon-docs_dist_preview_mjs-node_modules_storybook_react_dist_-6e62a9.iframe.bundle.js.map