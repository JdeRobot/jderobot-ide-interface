...
const handleActive = (p)=>{
    if (p.active) {
        return `
      background-color: ${p.color ?? secondaryColor} !important;
...
//# sourceMappingURL=components-Button-Button-stories.3fa32743b2f6086e3bb3.hot-update.js.map